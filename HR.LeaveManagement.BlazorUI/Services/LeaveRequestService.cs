...
public class LeaveRequestService : BaseHttpService, ILeaveRequestService
{
    ...
    public LeaveRequestService(IClient client, IMapper mapper, ILocalStorageService localStorageService) : base(client, localStorageService) => _mapper = mapper;
    ...
    public Task DeleteLeaveRequest(int id) => throw new NotImplementedException();
